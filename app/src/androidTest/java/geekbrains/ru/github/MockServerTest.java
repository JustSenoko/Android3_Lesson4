...
public class MockServerTest {
    ...
    public void getUsersSuccess() {
        ...
        retrofitHelper.getUserInfo(login)
                .subscribe(new DisposableSingleObserver<RetrofitModel>() {
                    @Override
                    public void onSuccess(RetrofitModel model) {
    ...
    public void getUsersWithErrorCode() {
        ...
        retrofitHelper.getUserInfo(login)
                .subscribeWith(new DisposableSingleObserver<RetrofitModel>() {
                    @Override
                    public void onSuccess(RetrofitModel retrofitModels) {
    ...
    public void getUsersWithWrongJson() {
        mockWebServer.enqueue(errorResponse(200, "{\"wrong_json\" : }"));
        TestSubscriber<Integer> subscriber = TestSubscriber.create();
        ...
        subscriber.awaitTerminalEvent();
        subscriber.assertError((e) -> (e instanceof MalformedJsonException));
